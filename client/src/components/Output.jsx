...
const Output = () => {
    ...
    const {view} = useContext(InputContext)
    //context api is used to get the value of response from the API 
    // console.log(view)
  return (
    <>
  ...
  <div>
    <form>
     <div className="w-[400px] m-4 h-[600px] sm:min-w-[400px] sm:max-w-[400px]  md:min-w-[600px] md:max-w-[700px] xl:min-w-[1000px] xl:max-w-[1000px]  mdborder border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
         ...
         <div className="px-4 py-2 bg-white h-[550px] rounded-b-lg dark:bg-gray-800">
             <div id="editor" rows="8" className="block w-full px-0 text-sm break-normal break-words text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400">
         
                 {view? <div>{view.newdata}</div>

             : <h1 className='text-gray-400'>Enter data to convert</h1> }
            </div>
         </div>
     </div>
